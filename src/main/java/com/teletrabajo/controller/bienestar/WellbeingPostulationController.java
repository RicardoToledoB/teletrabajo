...
public class WellbeingPostulationController {
    ...
    /**
     * Lista documentos asociados a una postulacion.
     * Permite al frontend mostrar los documentos y luego descargarlos con /documents/{documentId}/download.
     */
    @GetMapping("/{postulationId}/documents")
    public ResponseEntity<List<DocumentResponse>> getDocumentsByPostulation(@PathVariable Long postulationId) {
        return ResponseEntity.ok(service.getDocumentsByPostulation(postulationId));
    }

    /**
     * Lista documentos asociados a una postulacion propia del usuario autenticado.
     */
    @GetMapping("/my/{postulationId}/documents")
    public ResponseEntity<List<DocumentResponse>> getMyDocumentsByPostulation(@PathVariable Long postulationId) {
        return ResponseEntity.ok(service.getMyDocumentsByPostulation(postulationId));
    }
